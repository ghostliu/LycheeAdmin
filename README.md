...
或者通过git命令下载
#git命令下载
git clone https://github.com/ghostliu/LycheeAdmin.git
...
### 更新日志
 >> 1.element-ui升级的2.0.7，vue版本升级到2.5.9。  
 >> 2.增加server端提供模拟数据。  
 >> 3.主界面左侧菜单栏修改，使用element-ui升级的导航组件支持折叠功能。  
 >> 4.其它调整。
 ...
 > 2018-03-30
 >> 1.前台主界面，产品页，关于页部分内容调整
 >> 2.后台使用的模拟数据替换使用mysql数据库数据 


=======
git 使用
首先在git 网站上新建一个仓库lychee,复制https地址进行克隆
git clone https://github.com/ghostliu/LycheeAdmin.git
